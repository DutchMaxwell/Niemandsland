...
static func build(variant: int) -> ArrayMesh:
	...
	bark.set_shader_parameter("bark_tex",load("res://assets/terrain/reference/hero/bark.webp"))
	...
	foliage.set_shader_parameter("leaf_tex",load("res://assets/terrain/reference/hero/leaf.webp"))
