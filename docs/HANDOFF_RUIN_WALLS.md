...
- The **approved art set** is archived on R2 at
  `https://<legacy-cdn-host>/terrain-source/ruins/*.webp` (kept off-git so the repo stays
...
Archived on R2 at `https://<legacy-cdn-host>/terrain-source/ruins/<file>` (not bundled —
