...
1. **`/home/andreaskesberg/...` paths** (67 hits in 4 files):
...
2. **`assets.akesberg.de`** as the runtime asset CDN (22 files: all asset
...
D1: keep `assets.akesberg.de` or move to a neutral domain?
...
**Phase 2 — Clean (1–2 h):**
Remove `/home/andreaskesberg` paths; prune docs per D2; neutralize OPR
