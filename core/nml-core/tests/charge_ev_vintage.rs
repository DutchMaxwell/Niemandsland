...
fn seams_of(c: &ActCorpus, no_engage_fold: bool) -> Seams {
    Seams { spacing: c.knobs.seam_spacing, cast: c.knobs.seam_cast, hero_last: c.knobs.hero_last, path: c.knobs.seam_path,
        ...
        movement: c.knobs.movement, move_rigid: c.knobs.move_rigid, no_engage_fold, los_model: c.knobs.los_model,
        dangerous_end_morale: c.knobs.dangerous_end_morale, consolidate: c.knobs.consolidate, ..Seams::default() }
}
