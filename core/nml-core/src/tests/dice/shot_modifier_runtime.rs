use super::*;
    ...
    fn grounded_precision_adds_one_on_every_attack_while_in_terrain_at_epoch_6() {
        ...
        assert_eq!(
            melee_hit_target(&us.melee[0], &in_terrain, &defender(4, 5), false, 0, 0.0, false).0, 3,
        ...
        assert_eq!(
            melee_hit_target(&us.melee[0], &in_open, &defender(4, 5), false, 0, 0.0, false).0, 4,
        ...
        assert_eq!(
            melee_hit_target(&us5.melee[0], &in_terrain5, &defender(4, 5), false, 0, 0.0, false).0, 4,
