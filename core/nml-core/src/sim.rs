...
/// unit.rs Royal Legion stamp, and unit.rs's build-time aura-expansion read
/// (its fired grants) all log through the same NML_TRACE_RULES seam — one
/// shape for every rules-must-log line on this core.
