...
pub use acts::{
    ...
    ActStatics, ArbitrationRec, Expectation, Knobs, MeleeReach, PickRec, PolicyMode, RolloutValue,
    RunnerRec, Scored, Sighting,
};
pub use arbitration::{
...
pub use dice::{
    faces_to_hits, resolve_shooting_with_tray, resolve_volley_with_tray, Roll, ShootResult,
    Shooter, Tray,
};
...
pub use sim::{
    ...
    ADVANCE, BASE_CONTACT_EPSILON_IN, CHARGE, CHARGE_CONTACT_MARGIN_IN, CONTACT_IN,
