...
// ==== Re-Deployment (STANDALONE_SWEEP, epoch 33) ====
//
...
// re-placed anyone; from `EPOCH_33_REDEPLOYMENT` this pass mirrors the
...
pub fn redeployment_pass(
    ...
    if !rule_on(rules_epoch, EPOCH_33_REDEPLOYMENT) { return out; } // below: the choice stays table-side
    let specs = [specs1, specs2];
